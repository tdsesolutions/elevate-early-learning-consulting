...
const footerLinks = {
  ...
  services: [
    ...
    { label: "Staff Training", href: "/#services" },
    { label: "Program Assessment", href: "/#services" },
    { label: "Family Engagement", href: "/#services" },
  ],
  resources: [
    { label: "Blog", href: "#" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-semibold">
                Elevate<span className="text-amber-400">Early</span>
              </span>
            </Link>
            <p className="text-slate-400 mb-6 max-w-sm leading-relaxed">
              Empowering early childhood programs with expert consulting,
              curriculum development, and professional development services.
            </p>
        ...
        <div className="py-6 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-400 text-sm">
            © {currentYear} Elevate Early Learning & Consulting. All rights
            reserved.
          </p>
